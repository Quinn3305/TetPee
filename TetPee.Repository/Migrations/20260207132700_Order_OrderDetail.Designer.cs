...
namespace TetPee.Repository.Migrations
{
    ...
    [Migration("20260207132700_Order_OrderDetail")]
            ...
            modelBuilder.Entity("TetPee.Repository.Entity.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("53e0560d-1f28-4c89-b3c1-47a01a3445bd"),
                            Address = "Bien Hoa, Dong Nai",
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Status = "Completed",
                            TotalAmount = 100000m,
                            UserId = new Guid("211aeb20-0844-4cb2-992c-4b4d268163f1")
                        },
                        new
                        {
                            Id = new Guid("44943785-7842-4d4b-87a6-a050c020c09a"),
                            Address = "Bien Hoa, Dong Nai",
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Status = "Completed",
            ...
            modelBuilder.Entity("TetPee.Repository.Entity.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("adc81f18-8162-4360-aa45-f7e5544f13fb"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Áo thun nam chất liệu cotton cao cấp, thoáng mát, phù hợp cho mọi hoạt động hàng ngày.",
                            IsDeleted = false,
                            Name = "Áo Thun Nam",
                            Price = 199000m,
                            SellerId = new Guid("0843adf8-6cad-424b-a883-84db6271f2d2"),
                            UrlImage = "https://example.com/images/ao_thun_nam.jpg"
                        },
                        new
                        {
                            Id = new Guid("76069934-a89f-4ad0-be58-0ce218ba78b6"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("ecb6d6c9-98c8-46a5-9446-3ee4d330eb80"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("bed67eab-4d40-4dcc-8ccb-c050bc57c764"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("TetPee.Repository.Entity.Seller", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0843adf8-6cad-424b-a883-84db6271f2d2"),
                            CompanyAddress = "123 Main St, Cityville",
                            CompanyName = "ABC Company",
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            TaxCode = "TAXCODE123",
                            UserId = new Guid("921e6a2c-97bc-469a-aac0-c3e7079ef5ac")
                        });
                });
            ...
            modelBuilder.Entity("TetPee.Repository.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("921e6a2c-97bc-469a-aac0-c3e7079ef5ac"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("211aeb20-0844-4cb2-992c-4b4d268163f1"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),

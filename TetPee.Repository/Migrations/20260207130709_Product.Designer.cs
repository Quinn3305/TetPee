...
namespace TetPee.Repository.Migrations
{
    ...
    [Migration("20260207130709_Product")]
            ...
            modelBuilder.Entity("TetPee.Repository.Entity.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("8e1f3848-fb6a-4d13-bbb5-2db1aff4b8d3"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("71f87364-5124-42ac-a6ce-58fa13511f29"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("TetPee.Repository.Entity.Seller", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("41c12a10-53ce-4be9-b0a6-682ba98c9124"),
                            CompanyAddress = "123 Main St, Cityville",
                            CompanyName = "ABC Company",
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            TaxCode = "TAXCODE123",
                            UserId = new Guid("3e2f6c75-b888-42ef-9001-2fa6b718b45e")
                        });
                });
            ...
            modelBuilder.Entity("TetPee.Repository.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3e2f6c75-b888-42ef-9001-2fa6b718b45e"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("61aed652-be5b-4bfd-938d-fb41f5be53cf"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),

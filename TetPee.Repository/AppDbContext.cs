...
{
    //một class qtrong của Entity FW 
    //class đại điện qtr cho DB
    //đứng thay mặt cho DB
    //ko làm việc trực tiếp với Db
    //giống đại sứ quán mỹ
    ...
    //Hàm cho phép đặt lại tên table và rule cho cái db, add confict entity
            //add rule cho các mối quan hệ
             // ==================== User Configuration ====================
             //Kỹ thuật indexing thiên về cấu trúc dữ liệu và giải thuật xíu
             //Truy vấn Db nhanh hơn 
